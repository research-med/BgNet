...
class InputLyaerFusion(object):
    ...
    def __call__(self, results):
        ...
        if self.single_frame:
            ...
            # get images
            patch_target_size = (self.target_size[0] // 2, self.target_size[1])
            ...
            patch_h = patch_target_size[0]
            patch_w = patch_target_size[1]
            img = np.zeros((self.target_size[0], self.target_size[1],
                            axial1_img.shape[-1]),
                           dtype=axial1_img.dtype)
            img[:patch_h, :patch_w, :] = axial1_img
            img[patch_h:, :patch_w, :] = sagittal1_img
