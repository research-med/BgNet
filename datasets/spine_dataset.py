...
class SpineDataset(BaseDataset):
    ...
    def _get_age_weight_set_K(self, age):
        # the set K is obtained accoraing to the training set
        # The relationship between the probability of benign
        # and malignant patients and age

        # your should change your own weights
        index = [
        ...
        p = {
            '0-10': {
                'malignant': 0.11428571428571428,
                'benign': 0.8857142857142857
            },
            '11-20': {
                'malignant': 0.22727272727272727,
                'benign': 0.7727272727272727
            },
            '21-30': {
                'malignant': 0.25333333333333335,
                'benign': 0.7466666666666666
            },
            '31-40': {
                'malignant': 0.4090909090909091,
                'benign': 0.5909090909090908
            },
            '41-50': {
                'malignant': 0.4892086330935252,
                'benign': 0.5107913669064748
            },
            '51-60': {
                'malignant': 0.6818181818181818,
                'benign': 0.31818181818181823
            },
            '61-70': {
                'malignant': 0.7768595041322314,
                'benign': 0.22314049586776863
            },
            '71-80': {
                'malignant': 0.8636363636363636,
                'benign': 0.13636363636363635
            },
            '81-90': {
                'malignant': 1.0,
                'benign': 0.0
    ...
    def evaluate(self,
        ...
        for pred, target, patient_id in zip(results, gt_labels, patient_ids):
            ...
            p = pred[0]
            if self.age_on_decision:
                age_weight = self._get_age_weight_set_K(age)
                p = weight_p * p + weight_age * age_weight['malignant']
